...
DCGAN for CelebA dataset, following the PyTorch DCGAN tutorial [1] and according
to best practices for stability described by [2]. A more advanced exercise than
the DCGAN model for the MNIST dataset.
...
generator = Generator(in_channels=100, out_channels=3).to(device)
